        ...
        <div class="max-w-5xl mx-auto">
          ...
          <div class="mb-8 font-mono text-sm">
            ...
            <div class="text-orange-500/70 mb-2">
              <span class="text-orange-600">&gt;</span> EDITING GUIDE_{{ guide.id }}.md
            </div>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <!-- Current Image -->
            <div v-if="guide.image" class="border border-orange-500/30 bg-orange-500/5 p-6">
              <label class="text-orange-600 font-mono text-sm mb-3 block">
                <span class="text-orange-600">&gt;</span> CURRENT IMAGE:
              </label>
              <img :src="`/storage/${guide.image}`" alt="Current" class="max-h-48 border-2 border-orange-500" />
            </div>

            <!-- Image Upload -->
            <div class="border border-orange-500/30 bg-orange-500/5 p-6">
              <label class="text-orange-600 font-mono text-sm mb-3 block">
                <span class="text-orange-600">&gt;</span> NEW IMAGE (опционально):
              </label>
              <div
              ...
              >
                ...
                <div class="text-gray-400 font-mono text-sm">
                  ...
                  <p v-else>Загрузить новое изображение</p>
            ...
            <div class="border border-orange-500/30 bg-orange-500/5 p-6">
              <label class="flex items-center cursor-pointer">
                ...
                <span class="ml-3 text-orange-600 font-mono text-sm">
                  <span class="text-orange-600">&gt;</span> ОПУБЛИКОВАН
                </span>
              </label>
            </div>
            ...
            <div class="flex gap-4 pt-4">
              ...
              >
                ...
                {{ processing ? 'UPDATING...' : 'UPDATE_GUIDE_' }}
              </button>
