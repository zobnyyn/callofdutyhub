        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="mb-8 font-mono text-sm">
            ...
            <div class="text-orange-500/70 mb-2">
              <span class="text-orange-600">&gt;</span> LOADING ITEM_CREATE.exe
            </div>
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              ...
              <div class="border-2 border-dashed border-orange-500/30 p-8 text-center hover:border-orange-500/50 transition-all">
                ...
                <div v-else class="relative">
                  <img :src="imagePreview" class="max-h-64 mx-auto mb-4" />
                  <button
                    type="button"
                    @click="removeImage"
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              ...
              <p v-if="form.games.length === 0" class="text-yellow-500 text-xs mt-2 font-mono">
            ...
            <div class="flex gap-4 pt-4">
              ...
              >
                <span class="text-orange-900">&gt;</span> {{ processing ? 'CREATING...' : 'CREATE_ITEM' }}
              </button>
              <Link
                href="/admin/items"
...
const form = reactive({
  name: '',
  type: 'weapon',
  games: [], // Массив для множественного выбора игр
  rarity: null,
  description: '',
  image: null,
  sort_order: 0,
...
function submitForm() {
  ...
  // Создаем объект данных вручную, чтобы правильно обработать файлы
  const formData = {
    name: form.name,
    type: form.type,
