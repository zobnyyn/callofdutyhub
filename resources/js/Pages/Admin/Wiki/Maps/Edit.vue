        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="mb-8 font-mono text-sm">
            ...
            <div class="text-orange-500/70 mb-2">
              <span class="text-orange-600">&gt;</span> LOADING MAP_EDIT.exe
            </div>
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <!-- Current Image -->
            <div v-if="map.image" class="border border-orange-500/30 bg-black/50 p-6 relative">
              <div class="absolute top-0 left-0 w-full h-px bg-orange-500"></div>
              <label class="block font-mono text-xs text-orange-600 mb-2">
                <span class="text-orange-600">&gt;</span> ТЕКУЩЕЕ ИЗОБРАЖЕНИЕ:
              </label>
              <img :src="`/storage/${map.image}`" alt="Current image" class="h-40 object-contain border border-orange-500/20 p-2">
            </div>
            ...
            <!-- Current Minimap -->
            <div v-if="map.minimap" class="border border-orange-500/30 bg-black/50 p-6 relative">
              <div class="absolute top-0 left-0 w-full h-px bg-orange-500"></div>
              <label class="block font-mono text-xs text-orange-600 mb-2">
                <span class="text-orange-600">&gt;</span> ТЕКУЩАЯ МИНИКАРТА:
              </label>
              <img :src="`/storage/${map.minimap}`" alt="Current minimap" class="h-32 object-contain border border-orange-500/20 p-2">
            </div>
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              <div class="absolute top-0 left-0 w-full h-px bg-orange-500"></div>
              <label class="block font-mono text-xs text-orange-600 mb-2">
                <span class="text-orange-600">&gt;</span> НОВАЯ МИНИКАРТА:
              </label>
              <input
                ...
                class="w-full bg-black border border-orange-500/30 text-white px-4 py-3 font-mono focus:border-orange-500 focus:outline-none"
              />
              <p class="text-gray-500 text-xs mt-2">Оставьте пустым, чтобы сохранить текущую миникарту</p>
...
const submitForm = () => {
  ...
  router.post(`/admin/wiki/maps/${props.map.id}`, formData, {
    onFinish: () => {
