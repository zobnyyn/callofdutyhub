        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="mb-8 font-mono text-sm">
            ...
            <div class="text-orange-500/70 mb-2">
              <span class="text-orange-600">&gt;</span> LOADING WEAPON_CREATE.exe
            </div>
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              ...
              <input
                ...
                type="text"
                required
                placeholder="Например: M1 Garand, MP40, STG-44"
                class="w-full bg-black border border-orange-500/30 text-white px-4 py-3 font-mono focus:border-orange-500 focus:outline-none"
              />
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              ...
              <textarea
                ...
                rows="4"
                placeholder="Подробное описание оружия..."
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              <div class="absolute top-0 left-0 w-full h-px bg-orange-500"></div>
              <label class="block font-mono text-xs text-orange-600 mb-2">
                <span class="text-orange-600">&gt;</span> ИЗОБРАЖЕНИЕ:
              </label>
              <input
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              <div class="absolute top-0 left-0 w-full h-px bg-orange-500"></div>
              <label class="block font-mono text-xs text-orange-600 mb-2">
                <span class="text-orange-600">&gt;</span> ИКОНКА:
              </label>
              <input
                ...
                class="w-full bg-black border border-orange-500/30 text-white px-4 py-3 font-mono focus:border-orange-500 focus:outline-none"
              />
              <p class="text-gray-500 text-xs mt-2">Максимальный размер: 1MB</p>
            ...
            <div class="flex gap-4">
              ...
              >
                <span class="text-orange-600">&gt;</span> {{ processing ? 'СОЗДАНИЕ...' : 'СОЗДАТЬ ОРУЖИЕ' }}
              </button>
              <Link
                href="/admin/wiki/weapons"
...
const submitForm = () => {
  ...
  router.post('/admin/wiki/weapons', formData, {
    onFinish: () => {
