        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="mb-8 font-mono text-sm">
            ...
            <div class="text-orange-500/70 mb-2">
              <span class="text-orange-600">&gt;</span> LOADING ZOMBIE_MAP_CREATE.exe
            </div>
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              ...
              <input
                ...
                type="text"
                required
                placeholder="Например: Nacht der Untoten, Der Riese, Kino der Toten"
                class="w-full bg-black border border-orange-500/30 text-white px-4 py-3 font-mono focus:border-orange-500 focus:outline-none"
              />
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              ...
              <input
                ...
                type="text"
                placeholder="Например: Map Pack 1, Rezurrection, Zombies Chronicles"
                class="w-full bg-black border border-orange-500/30 text-white px-4 py-3 font-mono focus:border-orange-500 focus:outline-none"
              />
              <p class="text-gray-500 text-xs mt-2">Оставьте пустым, если карта входит в базовую игру</p>
            </div>
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              ...
              <textarea
                v-model="form.story"
                rows="6"
                placeholder="Подробная история и сюжет карты..."
                class="w-full bg-black border border-orange-500/30 text-white px-4 py-3 font-mono focus:border-orange-500 focus:outline-none resize-none"
              ></textarea>
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              <div class="absolute top-0 left-0 w-full h-px bg-orange-500"></div>
              <label class="block font-mono text-xs text-orange-600 mb-2">
                <span class="text-orange-600">&gt;</span> ФОНОВОЕ ИЗОБРАЖЕНИЕ:
              </label>
              <input
            ...
            <div class="border border-orange-500/30 bg-black/50 p-6 relative">
              <div class="absolute top-0 left-0 w-full h-px bg-orange-500"></div>
              <label class="block font-mono text-xs text-orange-600 mb-2">
                <span class="text-orange-600">&gt;</span> МИНИАТЮРА:
              </label>
              <input
            ...
            <div class="flex gap-4">
              ...
              >
                <span class="text-orange-600">&gt;</span> {{ processing ? 'СОЗДАНИЕ...' : 'СОЗДАТЬ ЗОМБИ-КАРТУ' }}
              </button>
              <Link
                href="/admin/wiki/zombie-maps"
...
const submitForm = () => {
  ...
  router.post('/admin/wiki/zombie-maps', formData, {
    onFinish: () => {
