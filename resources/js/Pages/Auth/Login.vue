<template>
  <div class="min-h-screen bg-black text-gray-100 font-[system-ui] relative overflow-hidden">
    <!-- SEO Meta Tags -->
    <Seo
      title="Вход | COD Terminal"
      description="Войдите в свой аккаунт COD Terminal для доступа к гайдам, мета-сборкам Warzone и сообществу игроков Call of Duty."
      keywords="вход, авторизация, логин, COD Terminal, Call of Duty"
    />
