<template>
  <div class="min-h-screen bg-black text-gray-100 font-[system-ui] relative overflow-hidden">
    <!-- SEO Meta Tags -->
    <SEO
      title="Регистрация | COD Terminal"
      description="Создайте свой аккаунт оператора на COD Terminal. Присоединяйтесь к сообществу игроков Call of Duty и получите доступ к эксклюзивным гайдам."
      keywords="регистрация, создать аккаунт, COD Terminal, Call of Duty, сообщество"
        ...
        <div class="max-w-2xl mx-auto">
          ...
          <div class="mb-6 md:mb-8 font-mono text-xs md:text-sm">
            ...
            <div class="text-orange-500/70 mb-2">
              <span class="text-orange-600">&gt;</span> LOADING REGISTRATION_MODULE.exe
            </div>
            <div class="text-orange-500 mb-4">
              <span class="text-orange-600">&gt;</span> NEW OPERATOR REGISTRATION
            </div>
          ...
          <form @submit.prevent="register" class="space-y-4 md:space-y-6">
            ...
            <div class="font-mono">
              ...
              <div v-if="errors.name" class="text-red-500 text-sm mt-2">
                <span class="text-red-600">&gt;</span> {{ errors.name[0] }}
              </div>
            </div>
            ...
            <div class="font-mono">
              <div class="text-orange-600 text-sm mb-2">
                <span class="text-orange-600">&gt;</span> CONFIRM_ACCESS_CODE:
              </div>
              <input
            ...
            <div class="text-center font-mono text-sm pt-4">
              <div class="text-gray-500 mb-2">
                <span class="text-orange-600">&gt;</span> УЖЕ_ЕСТЬ_АККАУНТ?
              </div>
              <a href="/login" class="text-orange-500 hover:text-orange-400 transition-colors">
                &gt; ВОЙТИ
              </a>
            </div>
          </form>
