      ...
      <div class="container mx-auto relative z-10">
        ...
        <div class="mb-6 md:mb-8 font-mono text-xs md:text-sm">
          ...
          <div class="text-orange-500/70 mb-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
            <span class="text-orange-600">&gt;</span> LOADING BLACKOPS_DATABASE.exe
          </div>
          <div class="text-orange-500/70 mb-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
            <span class="text-orange-600">&gt;</span> ACCESSING GAME ARCHIVES...
          </div>
          <div class="text-orange-500 mb-4 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
            <span class="text-orange-600">&gt;</span> SELECT YOUR OPERATION
          </div>
        ...
        <div class="mb-8 md:mb-12">
          ...
          <p class="text-base md:text-xl text-gray-300 leading-relaxed font-mono max-w-3xl drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
            Выберите игру из легендарной серии Black Ops и погрузитесь в мир тайных операций.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container mx-auto relative z-10">
        ...
        <div class="mb-6 md:mb-8 font-mono">
          <div class="text-orange-500 text-xs md:text-sm mb-2">
            <span class="text-orange-600">&gt;</span> AVAILABLE_OPERATIONS:
          </div>
        ...
        <div class="mt-12 font-mono">
          <div class="text-orange-600 text-sm mb-3">
            <span class="text-orange-600">&gt;</span> SERIES_INFO:
          </div>
