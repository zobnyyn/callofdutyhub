<template>
  <div class="min-h-screen bg-black text-gray-100 font-[system-ui] relative overflow-hidden">
    <!-- SEO Meta Tags -->
    <Seo
      title="Редактирование профиля | COD Terminal"
      description="Настройте свой профиль оператора на COD Terminal. Добавьте контакты, игровые никнеймы и персонализируйте аккаунт."
      keywords="редактирование профиля, настройки, профиль, COD Terminal"
    />
