<template>
  <div class="min-h-screen bg-black text-gray-100 font-[system-ui] relative overflow-hidden">
    <!-- SEO Meta Tags -->
    <Seo
      :title="`${profileUser.name} — Профиль | COD Terminal`"
      :description="`Профиль оператора ${profileUser.name} на COD Terminal. Достижения, друзья и статистика игрока Call of Duty.`"
      :keywords="`${profileUser.name}, профиль, игрок, COD Terminal, достижения, Call of Duty`"
      :image="profileUser.avatar ? `/storage/${profileUser.avatar}` : null"
    />
        ...
        <div class="max-w-5xl mx-auto">
          ...
          <div class="mb-6 border-b border-orange-500/30">
            <div class="flex gap-2 font-mono text-sm">
              ...
              >
                <span class="text-orange-600">&gt;</span> INFO
              </button>
              <button
              ...
              >
                ...
                <span class="text-orange-600">&gt;</span> ACHIEVEMENTS
                <span v-if="achievementsCount > 0" class="px-2 py-0.5 bg-orange-500 text-black text-xs rounded-full">{{ achievementsCount }}</span>
              </button>
              <button
              ...
              >
                ...
                <span class="text-orange-600">&gt;</span> ONLINE_USERS
              </button>
              <button
              ...
              >
                ...
                <span class="text-orange-600">&gt;</span> FRIENDS
              </button>
            </div>
          </div>
          ...
          <div v-show="activeTab === 'achievements'">
            <AchievementsTab :userId="profileUser.id" :isOwnProfile="$page.props.auth.user?.id === profileUser.id" @achievements-loaded="handleAchievementsLoaded" />
          </div>
          ...
          <div v-show="activeTab === 'friends'">
            <FriendsTab
              ...
              :isOwnProfile="$page.props.auth.user?.id === profileUser.id"
...
import OnlineUsersTab from '../../Components/OnlineUsersTab.vue';
...
function handleAchievementsLoaded(count) {
