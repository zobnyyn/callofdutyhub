    ...
    <section class="py-8 md:py-12 px-3 md:px-6 relative">
      <div class="container mx-auto relative z-10">
        ...
        <div v-if="guides.length === 0" class="text-center py-20">
          <div class="font-mono text-orange-500 mb-4 text-sm md:text-base">
            <span class="text-orange-600">&gt;</span> NO_GUIDES_FOUND
          </div>
          <p class="text-gray-400 text-sm md:text-base">Для этой карты пока нет опубликованных гайдов.</p>
        </div>

        <!-- Guides Grid -->
        <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-7xl">
          <div
            ...
            <div class="p-6">
              ...
              <div class="flex items-center justify-between pt-4 border-t border-orange-500/20">
                <div class="flex items-center gap-2">
                  <div class="w-8 h-8 rounded-full bg-orange-500/20 flex items-center justify-center text-orange-500 font-mono text-xs font-bold overflow-hidden">
                    <img
